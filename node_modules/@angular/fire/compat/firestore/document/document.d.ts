...
import { Action, DocumentData, DocumentReference, QueryDocumentSnapshot, QueryFn, SetOptions } from '../interfaces';
...
export declare class AngularFirestoreDocument<T = DocumentData> {
     ...
     */
    snapshotChanges(): Observable<Action<QueryDocumentSnapshot<T>>>;
    /**
