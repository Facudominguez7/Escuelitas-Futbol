...
import { Action, DocumentReference, QueryDocumentSnapshot, Query, QuerySnapshot } from '../interfaces';
export declare function fromRef<R, T>(ref: DocumentReference<T> | Query<T>, scheduler?: SchedulerLike): Observable<R>;
export declare function fromDocRef<T>(ref: DocumentReference<T>, scheduler?: SchedulerLike): Observable<Action<QueryDocumentSnapshot<T>>>;
